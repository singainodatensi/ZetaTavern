...
import * as ui from './ui.js?v=20260611b';
import { generateStoryResponse, generateLoreProfileFromSearch, normalizeLoreEntryName, isLikelyWorldLoreName } from './ai-client.js?v=20260611b';
import * as dropbox from './dropbox.js?v=20260611b';
...
async function submitStoryTurn(mode = 'normal') {
  ...
  try {
    ...
    queueDropboxAutoSync({ storyId: currentStory.storyId });
